...
public class ExpenseController {
    ...
    public ResponseEntity<ExpenseDetailResponseDto> updateExpense(@RequestBody ExpenseRequestDto dto,
            @RequestAttribute Long userId, @PathVariable Long expenseId) {
        return ResponseEntity.ok(expenseService.updateExpense(dto, userId, expenseId));
    }

    @GetMapping
    public ResponseEntity<List<ExpenseResumeResponseDto>> getAllExpenses(@RequestAttribute Long userId) {
        return ResponseEntity.ok(expenseService.getAllExpenses(userId));
    }

    @GetMapping("/by-currency")
    public ResponseEntity<List<ExpenseResumeResponseDto>> getAllExpensesByCurrency(@RequestAttribute Long userId,
            @RequestParam String currency) {
        return ResponseEntity.ok(expenseService.getAllByCurrency(userId, currency));
    }

    @GetMapping("/by-category")
    public ResponseEntity<List<ExpenseResumeResponseDto>> getAllExpensesByCategory(@RequestAttribute Long userId,
    ...
    @GetMapping("/by-group")
    public ResponseEntity<List<ExpenseResumeResponseDto>> getAllExpensesByGroup(@RequestAttribute Long userId,
    ...
    public ResponseEntity<Void> deleteExpense(@RequestAttribute Long userId, @PathVariable Long expenseId) {
